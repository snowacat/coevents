...
$(document).ready(function () {
    ...
    // Click button "Sended messages"
        $("#btnSendMessage").click(function () {
            var currentValue = $('#eventSendMessage').val();
            if (currentValue == "true") {
                $("#eventSendMessage").val("false");
                $("#btnSendMessage").html('Send messages').removeClass("btn btn-warning").addClass("btn btn-success");
            }
            else {
                $("#eventSendMessage").val("true");
                $("#btnSendMessage").html('Repeat send').removeClass("btn btn-success").addClass("btn btn-warning");
            }
        });
...
function geoSuccess(position) {
    // Get coords from hide inputs if this edit_event page. It need for draw map marker
    ...
    if ((inputLatitude != null && inputLatitude != "" && inputLatitude != 0) && (inputLongitude != null && inputLongitude != "" && inputLongitude != 0)) {
        ...
        // If this edit_event/create page without marker. Draw map and marker with default coords.
...
function geoError(error) {
    // Get coords from hide inputs if this edit_event page
    var inputLatitude = $('#eventLatitude').val();
    var inputLongitude = $('#eventLongitude').val();
